 ...
 *
 * Descricao: Codigo-Fonte de um programa de testes para a funcao "ObterMatrizTransposta".
 *
 * $Author: joao.vitor $
 * $Date: 2024/06/10 04:57:52 $
 * $Log: aula0504.c,v $
 * Revision 1.1  2024/06/10 04:57:52  joao.vitor
 * Initial revision
 *
 *
 *******************************************************************************/
...
main (int argc, char *argv [])
{
	...
	ld matrizTransposta [tamanhoColunasConvertido][tamanhoLinhasConvertido];
	...
	/*Efetua a transposicao da matriz inserida.*/
	ObterMatrizTransposta (tamanhoLinhasConvertido, tamanhoColunasConvertido, matrizInserida, matrizTransposta);

	/*Exibe as matrizes.*/
	printf ("\nMatriz Inserida:\n");
	ExibirMatriz (tamanhoLinhasConvertido, tamanhoColunasConvertido, matrizInserida);
	printf ("\nMatriz Transposta:\n");
	ExibirMatriz (tamanhoColunasConvertido, tamanhoLinhasConvertido, matrizTransposta);
